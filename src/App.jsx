    ...
    <div className="securevault-app">
      ...
      <main className="app-main-content">
        <nav className="breadcrumbs-container">
          ...
          <span className="breadcrumb-item">Legal Docs</span>
          <span className="breadcrumb-separator">/</span>
          <span className="breadcrumb-item">Contracts</span>
          <span className="breadcrumb-separator">/</span>
          <span className="breadcrumb-item">2024</span>
          <span className="breadcrumb-separator">/</span>
          <span className="breadcrumb-item active">Client A</span>
        </nav>
          ...
          <div className="preview-placeholder">
             <div className="preview-inner">
                <svg width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeOpacity="0.2">
                  ...
                  <path d="M12 11l3 3-3 3" strokeOpacity="1"/>
                </svg>
                <div className="preview-text">SAFE WORK</div>
             </div>
          </div>
          <h3 className="properties-filename">Client A - Assets</h3>
          
          <div className="properties-details">
            <h4 className="detail-heading">Details</h4>
            <div className="detail-row">
              <span className="detail-label">Type</span>
              <span className="type-badge">Directory</span>
            </div>
            <div className="detail-row">
              <span className="detail-label">Size</span>
              <span className="detail-value">42.8 MB (8 files)</span>
            </div>
            <div className="detail-row">
              <span className="detail-label">Modified</span>
              <span className="detail-value">Jan 12, 2024</span>
            </div>
          </div>
